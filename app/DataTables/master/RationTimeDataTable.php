...
class RationTimeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(RationTime $model): QueryBuilder
    {
    ...
    {
        return 'RationTime_' . date('YmdHis');
    }
}
