...
class RationDateDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', function ($rationDate) {
                $id = $rationDate->id;
                $btn = '';
     ...
     */
    public function query(RationDate $model): QueryBuilder
    {
    ...
    {
        return 'RationDate_' . date('YmdHis');
    }
}
