...
<div class="container-fluid">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Reciept for - {{ $demand_from_location->demand_ref }}</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-teal">
                        ...
                        <form role="form" method="POST" action="{{route('receipt_from_locations.store',$demand_from_location->id)}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="year" class="col-sm-3 col-form-label">{{ $demand_from_location->year }}</label>

                                    <label for="year" class="col-sm-1 col-form-label">Date</label>
                                    <label for="year" class="col-sm-3 col-form-label">{{ \Carbon\Carbon::parse($demand_from_location->request_date)->format('Y-m-d') }}</label>

                                    <label for="year" class="col-sm-1 col-form-label">Item</label>
                                    <label for="year" class="col-sm-3 col-form-label">{{ $demand_from_location->item->name }}</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="year" class="col-sm-3 col-form-label">{{ $demand_from_location->supplier->name }}</label>

                                    <label for="year" class="col-sm-1 col-form-label">Qty</label>
                                    <label for="year" class="col-sm-3 col-form-label">{{ $demand_from_location->qty }} {{ $demand_from_location->item->measurement->name }}</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        is-invalid @enderror" name="qty" value="{{ $demand_from_location->qty }}" id="qty" autocomplete="off"
                                               min="{{ date('Y') }}" max="3000">
                                        <span class="text-danger">@error('qty') {{ $message }} @enderror</span>
                                    </div>
                                    <label for="year" class="col-sm-2 col-form-label">{{ $demand_from_location->item->measurement->name }}</label>
                                </div>
