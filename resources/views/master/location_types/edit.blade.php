    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-teal">
                ...
                <form role="form" action="{{ route('location_types.update',$locationType->id) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                is-invalid @enderror" name="name" value="{{ $locationType->name }}" id="name" autocomplete="off">
